...
from hidet.ir.expr import Var, Expr, cast, deref
...
def register_ldmatrix_instructions():
    from hidet.lang import script, i32, u32, void_p, attrs, ref_u32
    ...
    for num in [1, 2, 4]:
        for trans in [False, True]:
            for shared_space_addr in [False, True]:
                ...
                smem_type = i32 if shared_space_addr else void_p
                if num == 1:
