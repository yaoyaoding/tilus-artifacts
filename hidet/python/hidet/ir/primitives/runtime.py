...
def register_functions():
    ...
    register_primitive_function(name='get_hip_stream', func_or_type=FuncType([], void_p), codegen_name='get_hip_stream')
    register_primitive_function(
    ...
    register_primitive_function(
        name='memory_planner_init', func_or_type=FuncType([int32], void), codegen_name='memory_planner_init'
    )
    register_primitive_function(
    ...
    register_primitive_function(
        name='memory_planner_free', func_or_type=FuncType([int32, int64], void), codegen_name='memory_planner_free'
    )
    register_primitive_function(
...
def get_hip_stream() -> void_p:
    return call_primitive_func('get_hip_stream', [])
...
def get_symbol_value_ptr(name: Union[str, Expr]) -> int32:
    return call_primitive_func('get_symbol_value_ptr', [name])


def set_symbol_value_ptr(name: Union[str, Expr], value: Expr):
    return call_primitive_func('set_symbol_value_ptr', [name, value])
