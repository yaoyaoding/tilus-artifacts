...
from .avaliability import available

from .device import device_count, synchronize, compute_capability, properties, profiler_start, profiler_stop
from .device import cudaDeviceProp, device_count, set_device, current_device, device
