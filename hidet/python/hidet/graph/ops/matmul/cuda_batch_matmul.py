...
class BatchMatmulTask(Task):
    def __init__(self, a: TensorNode, b: TensorNode, mma: str = 'simt'):
        ...
        self.n_size = n_size
        self.mma: str = mma
        self.implement_device_type: str = 'cuda' if hidet.cuda.available() else 'hip'
        c = compute(
            name='c',
    ...
    def implement_cuda(self, working_dir: str) -> List[IRModule]:
        self.implement_device_type = 'cuda'
...
class CudaBatchMatmulOp(Operator):
...
def cuda_batch_matmul(a: Tensor, b: Tensor, mma: str = 'simt') -> Tensor:
    ...
    """
    return CudaBatchMatmulOp(a, b, mma).outputs[0]
