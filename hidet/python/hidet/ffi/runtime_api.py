...
Stream = Union['hidet.cuda.Stream', 'hidet.hip.Stream']
...
class RuntimeAPI:
    ...
    @staticmethod
    def get_current_cuda_stream() -> int:
        ret: Optional[int] = RuntimeAPI._get_current_cuda_stream()
    ...
    def get_current_hip_stream() -> int:
        ret: Optional[int] = RuntimeAPI._get_current_hip_stream()
        return 0 if ret is None else ret
