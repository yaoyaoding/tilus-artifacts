#!/usr/bin/env python3
#
# This utility comes from the perfetto official repo:
#   https://github.com/google/perfetto/blob/b96e6f6df4f15f1e63e165de09768659f78159d1/tools/open_trace_in_ui
#
...
def main():
    examples = '\n'.join([ANSI.BOLD + 'Examples:' + ANSI.END, '  tools/open_trace_in_ui trace.pftrace'])
    ...
    parser.add_argument('-n', '--no-open-browser', action='store_true', default=False)
    parser.add_argument('--origin', default='https://ui.perfetto.dev')
    parser.add_argument('-i', '--trace', help='input filename (overrides positional argument)')
