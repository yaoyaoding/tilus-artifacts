...
from mutis.vm.ir.inst import Instruction, AllocateInst, ElementwiseBinaryInst, MmaDotInst
...
class MatmulMmaEmitter(InterBlockReduceEmitter, ReduceEmitter):
    ...
    def emit(self) -> Union[Stmt, Instruction]:
        ...
        inst = MmaDotInst(
            ...
            c=self.accumulator,
            mma_inst=self.variant['mma_inst'],
