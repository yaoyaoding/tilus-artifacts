...
def matmul4_kernel(
    ...
    for k in range(0, num_pid_k):
        ...
        # tl.device_print('shifted b: ', b)
        b = b * scales[None, :] - zeros[None, :]  # Scale and shift
        # tl.device_print('shifter: ', shifter)
        # tl.device_print('scales: ', scales)
        # tl.device_print('zeros: ', zeros)
        # tl.device_print('scaled b: ', b)
        #
        # tl.device_print('k: ', k)
        # tl.device_print('a: ', a)
        # tl.device_print('b: ', b)
        accumulator += tl.dot(a, b)
        # tl.device_print('acc: ', accumulator)
...
def triton_gemm_w4a16(
    ...
    def grid(meta):
        ...
        # print('num blocks:')
        # print(triton.cdiv(M, BLOCK_SIZE_M) * triton.cdiv(N, BLOCK_SIZE_N))
